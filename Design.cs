...
namespace c_sharp_ui
{
    public class StyleTextBox : Panel
    {
        ...
        private void Ani_Line(object obj)
        {
            ...
            for(int i =0; ;i++)
            {
                ...
                try
                {
                    ...
                    ga.DrawLine(color, line_start, this.rect.Height - 7, line_end, this.rect.Height - 7);

                    ga.DrawLine(color, updown_start, 0, updown_end,0);
                    ga.DrawLine(color, updown_start, this.rect.Height, updown_end, this.rect.Height);

                    ga.DrawLine(color, 0, lr_start, 0, lr_end);
                    ga.DrawLine(color, this.rect.Width, lr_start, this.rect.Width, lr_end);
                }
        ...
        private void Panel_MouseEnter(object sender,EventArgs e)
        {
            ...
            this.Paint_String(Brushes.CornflowerBlue);

            Thread ani_thread = new Thread(this.Ani_Line);
            ani_thread.IsBackground = true;
            ani_thread.Start(Pens.CornflowerBlue);
        }
        ...
        private void Panel_MouseLeave(object sender,EventArgs e)
        {
            ...
            this.Paint_String(Brushes.LightSkyBlue);

            Thread ani_thread = new Thread(this.Ani_Line);
            ani_thread.IsBackground = true;
            ani_thread.Start(Pens.LightSkyBlue);
        }
        private void Panel_Paint(object sender,PaintEventArgs e)
        {
            g.DrawRectangle(Pens.LightSkyBlue, rect);
            g.DrawLine(Pens.LightSkyBlue, 5, this.rect.Size.Height - 7, this.rect.Size.Width - 5, this.rect.Size.Height - 7);
            this.Paint_String(Brushes.LightSkyBlue);
        }
